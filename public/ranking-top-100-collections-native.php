...
<?php
    subpage_heading(
        'Top 100 Sportvatar Collections <br class="mobile-only">by Native Ability Scores',
    ...
    $sportvatar_collections = general_query("SELECT
        ...
        SUM(t1.ability) AS total_ability_score,
        ...
        ORDER BY total_ability_score DESC
        LIMIT 100
    ;");
?>
...
?>
            <tr>
                ...
                <td><?= $collection['total_ability_score']/2/5; ?></td>
