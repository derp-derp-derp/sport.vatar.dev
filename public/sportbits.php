...
<?php
    $sportbits = general_query("SELECT name, rarity, flow_id FROM templates WHERE category LIKE '%sportbit_hat%' OR category LIKE '%sportbit_accessory%' ORDER BY FIELD(rarity,'common','rare','epic','legendary'), name ASC");
